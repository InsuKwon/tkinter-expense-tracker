...
class DashboardWindow(tk.Toplevel):
    ...
    def _build_overview_tab(self):
        ...
        # Recent activity frame - using Frame with solid border
        ...
        recent_label = tk.Label(recent_container, text="Recent Activity",
                                font=('Arial', 12, 'bold'), bg='white')
        recent_label.pack(anchor='w', padx=5, pady=(5, 0))
    ...
    def _update_charts(self, categories):
        ...
        # Chart 3: Monthly Trends (in chronological order: oldest to newest)
        monthly_data = self.repo.get_monthly_spending()
        if monthly_data:
